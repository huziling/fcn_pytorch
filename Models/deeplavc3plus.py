...
class AsppModule(nn.Module):
    def __init__(self, bn_momentum=0.1, output_stride=16):
        ...
        #                                       , bn_momentum=bn_momentum)
        self._atrous_convolution1 = SeparableAsppConv(2048, 256, 1, 1, bn_momentum=bn_momentum)
        self._atrous_convolution2 = SeparableAsppConv(2048, 256, 3, 1, padding=atrous_rates[1], dilation=atrous_rates[1]
                                              , bn_momentum=bn_momentum)
        self._atrous_convolution3 = SeparableAsppConv(2048, 256, 3, 1, padding=atrous_rates[2], dilation=atrous_rates[2]
                                              , bn_momentum=bn_momentum)
        self._atrous_convolution4 = SeparableAsppConv(2048, 256, 3, 1, padding=atrous_rates[3], dilation=atrous_rates[3]
                                              , bn_momentum=bn_momentum)
        ...
        self._image_pool = nn.Sequential(
            ...
            nn.SyncBatchNorm(256,momentum=bn_momentum),
            nn.ReLU()
        )
...
class Encoder(nn.Module):
    def __init__(self, bn_momentum=0.1, output_stride=16):
        ...
        self.bn1 = nn.SyncBatchNorm(256,momentum=bn_momentum)
